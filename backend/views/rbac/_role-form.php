        ...
        <div class="ibox">
            ...
            <div class="ibox-content">
                ...
                <div class="form-group">
                    <span class="col-sm-2 control-label checkbox checkbox-success"><?= Html::checkbox("", false, ['id'=>'permission-all','class'=>'chooseAll'])?><label for='permission-all'><h4><?=yii::t('cms', 'Permissions')?></h4></label></span>
                    <div class="col-sm-10">
                        <?php
