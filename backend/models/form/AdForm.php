...
class AdForm extends \Common\models\Options
{
    ...
    public function attributeLabels()
    {
        return [
            'name' => yii::t('cms', 'Sign'),
            'input_type' => yii::t('cms', 'Ad Type'),
            'tips' => yii::t('cms', 'Description'),
            'ad' => yii::t('cms', 'Ad'),
            'link' => yii::t('cms', 'Jump Link'),
            'desc' => yii::t('cms', 'Ad Explain'),
            'autoload' => yii::t('cms', 'Status'),
            'sort' => yii::t('cms', 'Sort'),
    ...
    public function beforeSave($insert)
    {
        ...
        if ($upload !== null) {
            ...
            if (! $upload->saveAs($fullName)) {
                $this->addError('ad', yii::t('cms', 'Upload {attribute} error: ' . $upload->error, ['attribute' => yii::t('cms', 'Ad')]) . ': ' . $fullName);
                return false;
            }
